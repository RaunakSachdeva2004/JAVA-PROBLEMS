<h2><a href="https://www.geeksforgeeks.org/problems/bubble-sort/1?page=2&category=Arrays&difficulty=Basic,Easy&sortBy=submissions">Bubble Sort</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array,&nbsp;<strong>arr[]</strong>. Sort the array using bubble sort algorithm.<br></span></p>
